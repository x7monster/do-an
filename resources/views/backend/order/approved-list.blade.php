                ...
                <table id="example1" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr class="{{$order->id}}">
                      ...
                      <span style="background: #1BA160; padding: 5px; color: white">Chấp Nhận</span>
                      @endif
                    </td>
                    <td>
                      <a href="{{route('orders.details',$order->id)}}" class="btn btn-primary btn-sm"><i class="fa fa-eye"> Chi tiết</i></a>
                    </td>
                  </tr>
                    @endforeach
                  </tbody>
